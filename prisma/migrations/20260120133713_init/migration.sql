...
-- AddForeignKey
ALTER TABLE "projeto_pesquisa" ADD CONSTRAINT "projeto_pesquisa_area_conhecimento_id_fkey" FOREIGN KEY ("area_conhecimento_id") REFERENCES "area_conhecimento"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "projeto_pesquisa" ADD CONSTRAINT "projeto_pesquisa_corpo_id_fkey" FOREIGN KEY ("corpo_id") REFERENCES "corpo_projeto"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "projeto_pesquisa" ADD CONSTRAINT "projeto_pesquisa_cronograma_id_fkey" FOREIGN KEY ("cronograma_id") REFERENCES "cronograma"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "projeto_pesquisa" ADD CONSTRAINT "projeto_pesquisa_localidade_id_fkey" FOREIGN KEY ("localidade_id") REFERENCES "localidade"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "projeto_pesquisa" ADD CONSTRAINT "projeto_pesquisa_palavra_chave_id_fkey" FOREIGN KEY ("palavra_chave_id") REFERENCES "palavra_chave"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "projeto_pesquisa" ADD CONSTRAINT "projeto_pesquisa_plano_trabalho_id_fkey" FOREIGN KEY ("plano_trabalho_id") REFERENCES "plano_trabalho"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
